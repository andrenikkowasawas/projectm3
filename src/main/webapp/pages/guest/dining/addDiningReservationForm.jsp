...
<body class="background">
	...
	<div class="diningreservationform polaroid">
		<form
			action="http://localhost:8081/guest/dining/reservation/${diningId}/${guestId}"
			method="post">
			Reserve a table at:
			...
			<div class="form-group">
				Name:
				<p class="modalbody-ff">
					<i> ${guestFirstName} ${guestLastName} </i>
				</p>
			</div>
			<div class="form-group">
				Reservation Date: <input type="date" class="form-control"
					name="diningReservationDate">
			</div>

			<div class="form-group">
				Time Arriving: <input type="time" class="form-control"
					name="diningReservationTimeRange">
			</div>
			<div class="form-group">

				Number of Guests: <input type="number" class="form-control"
					name="diningReservationGoodFor">
			</div>


			<a class="btn btn-primary"
				href="http://localhost:8081/guest/diningList/${guestId}/dining-dashboard">Back</a>
			<button type="submit" class="btn btn-primary btn-reserve-now">Reserve
				Now</button>
