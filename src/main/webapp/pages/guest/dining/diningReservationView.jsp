	...
	<div class="modal-dialog modal-confirm">
		<div class="modal-content">
			...
			<div class="modal-body">
				<p class="text-center modal-alert-confirm">Your booking has been
					confirmed.</p>

				<p class="text-center modal-alert-confirm">Booking Number: ${ dr.id}</p>
				<p>
					Reservation Date:
					<fmt:formatDate pattern='MM/dd/yyy' type='date'
						value='${dr.diningReservationDate}' />
				</p>
			...
			<div class="modal-footer">
				<a
					href="http://localhost:8081/guest/diningList/${guestId }/dining-dashboard"
					class="btn btn-primary btn-block text-decoration-none">OK</a>
