...
<div class="d-flex flex-row bd-highlight mb-3 title" >
  <div class="p-2 bd-highlight"><a href="http://localhost:8081/guest/diningList/${guestId}/dining-dashboard"  ><i class=" material-icons">chevron_left</i></a></div>
  <div class="p-2 bd-highlight" >In-Room Dining Menu</div>
</div>
       	<div class=" container  overflow-auto" style="width: 800px; height: 400px; ">

       <c:forEach items="${inroomdiningmenulist}" var="ir">
<div class="d-flex justify-content-between " style="margin-bottom: 5px;">       		
<div>
       		<div ><h3> ${ir.menuName}</h3></div>
       		<div><p> ${ir.menuDescription}</p></div>
       		<div ><h5>Price: ${ir.menuPrice}</h5></div>
       		</div>
       		<div >
       		<img src="${pageContext.request.contextPath}/uploads/${ir.imgFilePath}" style="height:100px; width:180px;"/>
       		<form action="http://localhost:8081/guest/inRoomMenu/${ir.id}/${ir.menuName}/${guestId}"method="post">          
                    	<input class="btn btn-primary" type="number" name="Orders" value="1">
