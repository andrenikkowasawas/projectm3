...
<body class="background">
	...
	<div class="d-flex flex-row bd-highlight mb-3 title">
		<div class="p-2 bd-highlight">
			<a href="http://localhost:8081/guest/in-room-menu-list/${guestId}"><i
	...
	<div class="diningreservationform polaroid">
		<form
			action="http://localhost:8081/guest/inRoomMenu/Order/${menuId}/${Orders}/${guestId}/${menuPrice}"
			method="post">
			In Order:
			...
			<div class="form-group">
				Number of Orders: ${Orders}<br> Total Amount:${menuPrice}
			</div>
