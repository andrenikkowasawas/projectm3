...
<div class="d-flex flex-row bd-highlight mb-3 title" >
  <div class="p-2 bd-highlight"><a href="http://localhost:8081/guest/in-room-menu-list/${guestId}"  ><i class=" material-icons">chevron_left</i></a></div>
  <div class="p-2 bd-highlight" ><h1>${menuName}</h1></div>
</div>
<div class="diningreservationform polaroid">
<form action="http://localhost:8081/guest/inRoomMenu/Order/${menuId}/${Orders}/${guestId}/${menuPrice}" method="post">
In Order: <p class="modalbody-ff"><i> ${menuName}</i> </p>
...
Name: <p class="modalbody-ff"><i> ${guest.guestFirstname}  ${guest.guestLastname} </i></p>
	...
	<div class="form-group">
	Number of Orders: ${Orders}<br>
	Total Amount:${menuPrice}
	</div>
