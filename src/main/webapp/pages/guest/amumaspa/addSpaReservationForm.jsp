...
<body class="background">
	...
	<div class="diningreservationform polaroid">
		<form
			action="http://localhost:8081/guest/amumaspa/reservation/${guest.id}/${service.id}"
			method="post">
			Service:
