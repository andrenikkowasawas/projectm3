...
<body class="background">
	...
	<div class="d-flex flex-row bd-highlight mb-3 title">
		<div class="p-2 bd-highlight">
			<a href="http://localhost:8081/guest/${guestId }/relax/spa"><i
				class=" material-icons">chevron_left</i></a>
		</div>
		<div class="p-2 bd-highlight">Spa / ${service.serviceName }</div>
	</div>
	...
	<div class="card service-info-card">
		...
		<div class="d-flex justify-content-between">
			...
			<img
				src="${pageContext.request.contextPath}/uploads/${service.imgFilePath}"
				alt="First slide" class="serviceinfo-img">
			<div class="card-body">
				<p class="card-text p-card-service-info">${service.serviceDescription }</p>
				<div class="d-flex justify-content-between">

					<p class="p-service-info-rate">RATE: ${service.servicePrice } |
						${service.serviceDuration }</p>
					<a
						href="http://localhost:8081/guest/amumaspa/${guestId }/${service.id }/addreservation"
						class="btn btn-primary" style="padding-top: 10px;">RESERVE NOW</a>
