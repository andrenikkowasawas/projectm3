...
<img  src="${pageContext.request.contextPath}/uploads/${service.imgFilePath}" alt="First slide" style="width: 230px; height: 260px;">
<div class="card-body">
    <p class="card-text p-card-service-info">${service.serviceDescription }</p>
   <div class="d-flex justify-content-between">
   
     <p class="p-service-info-rate">RATE:  ${service.servicePrice }  |  ${service.serviceDuration }</p>
      <a href="http://localhost:8081/guest/amumaspa/${guestId }/${service.id }/addreservation" class="btn btn-primary" style="padding-top: 10px;">RESERVE NOW</a>
