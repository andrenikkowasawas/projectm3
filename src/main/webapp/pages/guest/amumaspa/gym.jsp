...
<body class="background">
	...
	<div class="card polaroid "
		...
		<div class="d-flex justify-content-between">
			...
			<img src="${pageContext.request.contextPath}/image/amumaspagym.jpg"
				alt="amuma spa gym" class="gym-img">
			<div class="card-body ">
				<p class="card-text gym-p">Enhance your spa experience with a
					variety of wellness activities while on vacation. The Spa has a
					fully-equipped Gym for you to continue your fitness regimen or
					start a new one with a Personal Trainer. Zumba sessions, Yoga and
					other wellness activities can also be availed upon prior
					reservation at the Amuma Spa.</p>
