...
<body class="background">
	...
	<div class="d-flex justify-content-around boxboard">
		...
		<div class="relax">
			<a href="http://localhost:8081/guest/${guestId}/relax/spa"><img
				class="relax-menu-img polaroid"
				src="${pageContext.request.contextPath}/image/therapies.png"
				alt="spa"></a>
		...
		<div class="relax">
			<a href="http://localhost:8081/guest/${guestId }/relax/gym"><img
				class="relax-menu-img polaroid"
				src="${pageContext.request.contextPath}/image/gym.png" alt="gym"></a>
			<div class="relax-menu">
		...
		<div class="relax">
			<a href="http://localhost:8081/guest/${guestId }/relax/salon"><img
				class="relax-menu-img polaroid"
				src="${pageContext.request.contextPath}/image/salon.png" alt="salon"></a>
			<div class="relax-menu">
