...
<img src="${pageContext.request.contextPath}/image/bluewaterlogo.png" class="img-fluid" alt="Responsive image">
  ...
  <div class="d-flex justify-content-around boxboard">
    ...
    <div  class="relax"> <a href="http://localhost:8081/guest/amumaspa/${guestId}/${service.id}"><img class="relax-menu-img polaroid" src="${pageContext.request.contextPath}/uploads/${service.imgFilePath}" alt="First slide"></a>
