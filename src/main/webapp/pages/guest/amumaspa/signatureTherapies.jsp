...
<body class="background">
	...
	<div class="d-flex flex-row bd-highlight mb-3 title">
		...
		<div class="p-2 bd-highlight">Signature Therapies</div>
	</div>
	...
	<div class="d-flex justify-content-around boxboard">
		<c:forEach items="${servicesList}" var="service">
			...
			<div class="relax">
				<a
					href="http://localhost:8081/guest/amumaspa/${guestId}/${service.id}"><img
					class="relax-menu-img polaroid"
					src="${pageContext.request.contextPath}/uploads/${service.imgFilePath}"
					alt="First slide"></a>
				<div class="p-signature-therapy">
					<p class="display-5 ">${service.serviceName}</p>
				</div>
			</div>
