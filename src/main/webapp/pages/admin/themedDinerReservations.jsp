...
<mt:admin_template title="Inventory">
  ...
  <div class="content-wrapper" style="min-height: 925.8px;">
	...
	<div class="box-body no-padding">
         ...
         <c:when test = "${tdr.status == 'Open'}">
												<td><a href="http://localhost:8081/admin/themedDiner/reservation/all/update/${tdr.id}">CLOSE</a></td>
        </c:when>
         
         <c:otherwise>
												<td><a href="http://localhost:8081/admin/themedDiner/reservation/all/delete/${tdr.id}">DELETE</a></td>
         </c:otherwise>
      </c:choose>
											</tr>
											</c:forEach>
