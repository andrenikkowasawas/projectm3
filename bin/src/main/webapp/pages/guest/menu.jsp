...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    ...
    <div class="row">
    <div class="col"> <a  class="display-5 text-decoration-none" href="http://localhost:8081/guest/${guestId}/resort-services"> <img class="menu-img" src="${pageContext.request.contextPath}/image/services.jpg" alt="resort services"></a>
    <div class="carousel-caption" id="pad">
 ...
 <div class="col"> <a class="display-5 text-decoration-none" href="http://localhost:8081/guest/diningList/${diningId}/${guestId}/dining-dashboard">  <img class="menu-img" src="${pageContext.request.contextPath}/image/dining.jpg" alt="dining"></a>
   ...
   <a class="display-5 text-decoration-none" href="http://localhost:8081/guest/${guestId}/relax-menu">RELAX</a>
    ...
    <div class="row">
    <div class="col"> <img class="menu-img" src="${pageContext.request.contextPath}/image/adv.jpg" alt="First slide">
    <div class="carousel-caption">
    <a href="http://localhost:8081/guest/${guestId}/adventures">ADVENTURES</a>
</div>
</div> 
 
    <div class="col">  <img class="menu-img" src="${pageContext.request.contextPath}/image/event.jpg" alt="Second slide">
   <div class="carousel-caption">
    <a href="http://localhost:8081/guest/${guestId}/events">EVENTS</a>
  </div>
  </div> 
    ...
    <div class="carousel-caption">
    <a href="http://localhost:8081/guest/${guestId}/feedback">FEEDBACK</a>
