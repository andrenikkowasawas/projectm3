...
<title>themed diner Reservation view</title>
...
<div class="modal-dialog modal-confirm">
	...
	<p class=" modal-alert-confirm"><fmt:formatDate pattern='MM/dd/yyy' type = 'date'  value = '${diningReservationDate}' />Reservation Date:</p>
			...
			<p class="text-center modal-alert-confirm">Booking Number: ${ tdr.id}</p>
					${tdr.themedDinerReservationDate }<br>
					${tdr.themedDinerArrivalTime }<br>
					${tdr.themedDinerGuests }<br>
			
			</div> 
			<div class="modal-footer">
       <a href="http://localhost:8081/guest/diningList/${guest.id }/dining-dashboard" class="btn btn-primary btn-block" >OK</a>
