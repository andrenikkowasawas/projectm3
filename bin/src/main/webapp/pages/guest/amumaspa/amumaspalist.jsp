...
<img src="${pageContext.request.contextPath}/image/bluewaterlogo.png" class="img-fluid" alt="Responsive image">
  ...
  <div class="p-2 bd-highlight" style="color:white; font-size: 35px; font-family: 'Varela Round', sans-serif;">Relax</div>
</div>
  
  <div class="d-flex justify-content-around boxboard">
    		<c:forEach items="${categoryList}" var="category">
    
    <div  class="relax"> <a href="http://localhost:8081/guest/${guestId}/${category.id}/amumaspa"><img class="relax-menu-img polaroid" src="${category.imgFilePath}" alt="First slide"></a>
  <div style="margin-left: 20px; font-size: 25px; width: 125px; " >
<p class="display-5" style="margin-top: -80px; color:black;">${category.spaCategory}</p>
</div>
</div> 
