...
<div class="modal-dialog modal-confirm">
	...
	<p class=" modal-alert-confirm"><fmt:formatDate pattern='MM/dd/yyy' type = 'date'  value = '${diningReservationDate}' />Reservation Date:</p>
			...
			<p class="text-center modal-alert-confirm">Booking Number: ${ sr.id}</p>
			
			</div> 
			<div class="modal-footer">
<button type="button" class="btn btn-primary btn-block" ><a href="http://localhost:8081/guest/${guestId }/relax/spa" >	OK</a></button>
