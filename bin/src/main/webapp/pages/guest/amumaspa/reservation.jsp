...
<title>gym-salon reservation view</title>
...
<div class="modal-dialog modal-confirm">
		<div class="modal-content">
			<div class="modal-header">
				<div class="icon-box">
					<i class="material-icons" style="margin:auto;">&#xE876;</i>
				</div>				
	...
	<p class=" modal-alert-confirm"><fmt:formatDate pattern='MM/dd/yyy' type = 'date'  value = '${diningReservationDate}' />Reservation Date:</p>
			...
			<p class="text-center modal-alert-confirm">Booking Number: ${ reservationId}</p>
			</div> 
			<div class="modal-footer">
<button type="button" class="btn btn-primary btn-block" ><a href="http://localhost:8081/guest/${guest.id }/relax-menu" >	OK</a></button>
