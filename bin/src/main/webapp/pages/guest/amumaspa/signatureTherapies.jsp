...
<img src="${pageContext.request.contextPath}/image/bluewaterlogo.png" class="img-fluid" alt="Responsive image">
  ...
  <div class="p-2 bd-highlight">${category.spaCategory}</div>
</div>
  
  <div class="d-flex justify-content-around boxboard">
    		<c:forEach items="${services}" var="service">
    
    <div  class="relax"> <a href="http://localhost:8081/guest/amumaspa/${guestId}/${category.id}/${service.id}"><img class="relax-menu-img polaroid" src="${service.imgFilePath}" alt="First slide"></a>
  <div style="margin-left: 20px; font-size: 25px; width: 125px; " >
<p class="display-5" style=" color:white;">${service.serviceName}</p>
</div>
</div> 
