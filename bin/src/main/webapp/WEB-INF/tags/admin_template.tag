...
<!-- THIS IS ROOMS -->
		<li>
          <a href="/admin/roomList">
            <i class="fa fa-television"></i> <span>ROOMS</span>
          </a>
        </li>
<!-- 	<li class="treeview"> -->
<!--           <a href="#"> -->
...
<!--            <li><a href="/admin/room/add"><i class="fa fa-circle-o"></i>ADD ROOM</a></li>  -->
<!--             <li><a href="/admin/roomList"><i class="fa fa-circle-o"></i>ROOM LIST</a></li> -->
<!--           </ul> -->
<!--         </li> -->
<!-- END ROOM -->
<!-- DINER HERE -->
	<li class="treeview">
          ...
          <ul class="treeview-menu">
         <!--   <li><a href="http://localhost:8081/admin/dining/add"><i class="fa fa-circle-o"></i>ADD DINING</a></li>-->
            <li><a href="/admin/diningList"><i class="fa fa-circle-o"></i>DINING LIST</a></li>
<!--             <li><a href="http://localhost:8081/admin/themed-diner/add"><i class="fa fa-circle-o"></i>ADD THEMED DINER</a></li> -->
            <li><a href="/admin/themedDinerList"><i class="fa fa-circle-o"></i>THEMED DINER LIST</a></li>
            <li><a href="/admin/in-room-dining-category/add"><i class="fa fa-circle-o"></i>ROOM DINING CATEGORY</a></li>
            <li><a href="/admin/in-room-dining-category-list"><i class="fa fa-circle-o"></i>INROOM DINING CAT LIST</a></li>
            <li><a href="/admin/in-room-dining-category-list/orderlist"><i class="fa fa-circle-o"></i>INROOM ORDER LIST</a></li>
          </ul>
        </li>
<!-- END DINER -->
<!-- AMUMA SPA START -->
	<li class="treeview">
          ...
          <ul class="treeview-menu">
           <li><a href="/admin/amumaSpaCategory/add"><i class="fa fa-circle-o"></i>ADD AMUMASPA CATEGORY</a></li>
            <li><a href="/admin/amumaSpaCategoryList"><i class="fa fa-circle-o"></i>AMUMA CATEGORY LIST</a></li>
            <li><a href="/admin/amumaSpaServicesList"><i class="fa fa-circle-o"></i>AMUMA SERVICE LIST</a></li>
          </ul>
        </li>
<!-- END AMUMA SPA -->
<!-- RESORT SERVICES START -->
	<li class="treeview">
          ...
          <ul class="treeview-menu">
<!--             <li><a href="/admin/resort-services/add"><i class="fa fa-circle-o"></i>ADD RESORT SERVICE</a></li> -->
            <li><a href="/admin/resort-services-list"><i class="fa fa-circle-o"></i>RESORT SERVICE LIST</a></li>
          </ul>
        </li>
<!-- END RESORT SERVICES -->
<!-- EVENT START -->
	<li class="treeview">
          ...
          <ul class="treeview-menu">
<!--             <li><a href="/admin/events/add"><i class="fa fa-circle-o"></i>ADD EVENT</a></li> -->
            <li><a href="/admin/eventsList"><i class="fa fa-circle-o"></i>EVENT LIST</a></li>
          </ul>
        </li>
<!-- EVENT END -->
<!-- EVENT START -->
	<li class="treeview">
          ...
          <ul class="treeview-menu">
<!--             <li><a href="/admin/events/add"><i class="fa fa-circle-o"></i>ADD EVENT</a></li> -->
            <li><a href="/admin/feedbackList"><i class="fa fa-circle-o"></i>FEEDBACK LIST</a></li>
          </ul>
        </li>
<!-- EVENT END -->
<!--  -->
